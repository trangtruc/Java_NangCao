...
<head>
	...
	<title>DANH SÁCH CMND/CCCD</title>
</head>
<body>
...
<sec:authorize access="!hasRole('XEM_DANH_SACH_CCCD')">
				    		...
				    		<div class="col-md-5">
				    			...
				    			<div class="col-md-8">
					    			<input type=text id=txtTimKiem
					    			 placeholder="Nhập họ tên hoặc số cmnd/cccd.."
					    			  class="form-control" onkeyup="timKiemCCCD();"/>
				    			 </div>
				    		</div>
		    		</div>		    		
		    	</div>
...
<script>
function timKiemCCCD(){
	var tuKhoa = "keySearch="+$("#txtTimKiem").val();
	$.ajax({url: 'tim-kiem-can-cuoc-cong-dan',
		type: 'GET',
		data: tuKhoa,
