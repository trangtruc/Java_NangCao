...
<head>
	...
	<title>DANH SÁCH TRẢ THẺ CĂN CƯỚC CÔNG DÂN</title>
</head>
<body>
		...
		<div class="row bg-content">
		    ...
		    <div class="col-md-9 radius-01 bg-white">
		    		<div class="text-center row title">
						DANH SÁCH TRẢ THẺ CĂN CƯỚC CÔNG DÂN
					</div>
			    	<div class="row">
			    		<div class="col-md-12">
					    		...
					    		<div class="col-md-5">
					    			...
					    			<div class="col-md-8">
						    			<input type=text id=txtTimKiem
						    			 placeholder="Nhập số căn cước hoặc mã số đăng ký .."
...
<script>
	function timKiemThe(){
		...
		$.ajax({url: 'tim-kiem-the-cmt-chua-tra',
			type: 'GET',
			data: str,
