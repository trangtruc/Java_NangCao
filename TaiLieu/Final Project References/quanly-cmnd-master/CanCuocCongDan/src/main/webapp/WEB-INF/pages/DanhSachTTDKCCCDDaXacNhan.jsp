...
<head>
	...
	<title>DANH SÁCH ĐĂNG KÝ ĐÃ ĐƯỢC XÁC NHẬN</title>
</head>
<body>
			...
			<div class="col-md-9">
				<div class="row radius-01 bg-white">
			    	...
			    	<div class="row title col-md-12 text-center">
			    		THÔNG TIN ĐĂNG KÝ CĂN CƯỚC CÔNG DÂN ĐÃ XÁC NHẬN
			    	</div>
					<div class="row mt60">
						<div class="col-md-12">
...
<script>
	function timKiem(){
		...
		$.ajax({url: 'tim-kiem-don-dang-ky-da-xac-nhan',
			type: 'GET',
			data: str,
	...
	function rutDon(vlue){
		if(!confirm("Bạn có chắc chắn muốn rút đơn này?")){
			return false;
		}
		var data = "maSo="+vlue;
		$.ajax({url: 'rut-don-cho-duyet',
			type: 'GET',
			data: data,
		  	success: function(result){
	        }});
		window.location = "danh-sach-dang-ky-da-xac-nhan";
	}
	function changeNgay(vlue){
		var ngay = ngayThangNam(vlue);
		window.location = "danh-sach-dang-ky-da-xac-nhan?ngay="+ngay;
	}
</script>