...
<title>THỐNG KÊ ĐƠN ĐĂNG KÝ CĂN CƯỚC CÔNG DÂN ${thoiGian }</title>
</head>
<body class="bg-white">
...
<div class="container mt20">
	<div class="row text-center">
		...
		<label class="title">${thoiGian }</label>
		<hr>
		<h4 class="text-left">Cơ cấu đơn đăng ký căn cước công dân trong ${thoiGian }</h4>
		<table border="1">
			<tr>
