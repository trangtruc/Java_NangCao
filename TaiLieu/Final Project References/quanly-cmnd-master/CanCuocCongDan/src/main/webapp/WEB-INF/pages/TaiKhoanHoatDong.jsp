...
<title>QUẢN LÝ TÀI KHOẢN HOẠT ĐỘNG</title>
</head>
<body>
		...
		<div class="row bg-content">
			...
			<div class="col-md-9">
					...
					<div class="col-md-10">
						<table border=0 class="row mt20">
							...
							<tr class="row mt5">
								...
								<td colspan=3>
									<select name="updateMaQuyen" id="updateMaQuyen" class='form-control'>
										<c:forEach items='${dsQuyen}' var='quyen'>
											<option id="option" value="${quyen.maQuyen}">${quyen.moTaQuyen}</option>
										</c:forEach>
									</select>
								</td>
							</tr>
				...
				<div class="radius-01 bg-white">
					...
					<div class="title row text-center">Danh sách tài khoản đang hoạt động</div>
					<div class="row">
						<div class="col-md-7">
						</div>
					...
					<div class="row mt20" style='height:420px;overflow:auto;'>
						<table border=1>
							<tr><th>Tài khoản</th>
							<th>Họ tên</th>
...
<script>
	function timKiemTaiKhoan(){
		...
		$.ajax({url: 'tim-kiem-tai-khoan-hoat-dong',
			type: 'GET',
			data: tuKhoa,
	...
	function khoaUser(taiKhoan){
		...
		$.ajax({url: 'khoa-user',
			...
			data: taiKhoan,
		  	success: function(result){
		  		window.location = "quan-ly-tai-khoan-hoat-dong";
	    }});
	}
