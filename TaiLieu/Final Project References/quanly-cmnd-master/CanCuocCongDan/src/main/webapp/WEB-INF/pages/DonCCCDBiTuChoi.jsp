...
<head>
	...
	<title>DANH SÁCH CĂN CƯỚC CÔNG DÂN BỊ TỪ CHỐI</title>
</head>
<body>
		...
		<div class="row bg-content">
		    ...
		    <div class="col-md-9">
		    	<div class="row radius-01 bg-white">
			    	<div class="text-center row col-md-12 title">
						HỒ SƠ ĐĂNG KÝ CĂN CƯỚC CÔNG DÂN BỊ TỪ CHỐI
					</div>
			    	<div class="row">
			    		<div class="col-md-12">
					    			...
					    			<div class="col-md-8">
						    			<input type=text id=txtTimKiem
						    			 placeholder="Nhập họ tên hoặc mã số đăng ký .."
						    			  class="form-control" onkeyup="timKiemDonBiTuChoi();"/>
					    			 </div>
					    		</div>
			    		</div>		    		
			    	</div>
...
<script>
function timKiemDonBiTuChoi(){
	var tuKhoa = "keySearch="+$("#txtTimKiem").val();
	$.ajax({url: 'tim-kiem-don-ttdk-cccd-bi-tu-choi',
		type: 'GET',
		data: tuKhoa,
